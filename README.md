...
### 3-Import a Database:
- open the **XAMPP** and make server action By pressing the button **Start** For both Module **Apache** and **MySQL** Next step go to button **Admin** in Actions MySQL and thin He will take you to a page PHPMyAdmin and thin click on **New** Next go to **Import** to the taskbar next click **Choose File** and Select the file that contains SQL next click **Open** and thin click **Import** To show you the contents.
### Run the Application:
